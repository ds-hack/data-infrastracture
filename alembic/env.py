...
from src.main.stock.dto import stock_dto  # noqa #402
...
config.set_section_option(section, "POSTGRES_HOST",
...
target_metadata = stock_dto.Base.metadata
...
def run_migrations_online():
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            target_metadata=target_metadata,
            compare_type=True,  # 型の変更を検知する設定を追加
